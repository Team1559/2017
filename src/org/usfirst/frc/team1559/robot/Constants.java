...
public class Constants {
	...
	public static final float NOMIAL_FWD_VOUT = +0.0f; //The forward nomial output voltage for the talons
	public static final float NOMIAL_REV_VOUT = -0.0f; //The forward peak output voltage for the talons
	public static final float PEAK_FWD_VOUT = +0.0f; //The reverse nomial output voltage for the talons
